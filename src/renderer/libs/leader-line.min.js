...
var LeaderLine = (function() {
      ...
      function(e) {
        ...
        return (
          ...
          (!(t = Object.getPrototypeOf(e)) ||
            ((n = t.hasOwnProperty('constructor') && t.constructor) && 'function' == typeof n && i.call(n) === l))
        );
      }),
    w =
      Number.isFinite ||
            ...
            if (((u = b / t), (s = [E(0, 0)]), 0 === i[0] && 0 === i[1] && 1 === i[2] && 1 === i[3]))
              ...
              for (c = h = (p = u) / 10; c <= 1; c += h)
                void 0,
                  (S = (y = (f = c) * f) * f),
                  (_ = 3 * (m = 1 - f) * y),
                  p <= (d = { x: (g = 3 * (m * m) * f) * i[0] + _ * i[2] + S, y: g * i[1] + _ * i[3] + S }).x &&
                    (s.push(E(d.x, d.y)), (p += u));
            s.push(E(1, 1));
          }
          return (
            (r = { animId: v, frameCallback: e, duration: t, count: a, frames: s, reverse: !!o }),
            k.push(r),
            !1 !== l && O(r, l),
            v
          );
          ...
          o.prototype = {
            parseSegment: function() {
              ...
              if (null === t) {
                ...
                if (
                  null ===
                  (t =
                    ('+' === e || '-' === e || '.' === e || ('0' <= e && e <= '9')) && 'Z' !== this._prevCommand
                      ? 'M' === this._prevCommand
                        ? 'L'
                        : 'm' === this._prevCommand
                        ? 'l'
            ...
            _parseNumber: function() {
              ...
              if (
                ...
                this._currentIndex === this._endIndex ||
                  ((this._string[this._currentIndex] < '0' || '9' < this._string[this._currentIndex]) &&
                    '.' !== this._string[this._currentIndex]))
              )
                return null;
              for (
              ...
              if (
                ...
                if (
                  ...
                  '+' === this._string[this._currentIndex]
                    ? (this._currentIndex += 1)
                    : '-' === this._string[this._currentIndex] && ((this._currentIndex += 1), (o = -1)),
                  this._currentIndex >= this._endIndex ||
                    this._string[this._currentIndex] < '0' ||
                    '9' < this._string[this._currentIndex])
                )
              ...
              return (
                e.forEach(function(e) {
                  if ('M' === e.type) {
                    ...
                    if (0 === p || 0 === c) S.push({ type: 'C', values: [v, E, t, n, t, n] }), (v = t), (E = n);
                    else if (v !== t || E !== n)
                ...
                var t = S(
                  ...
                  n.forEach(function(e) {
                    ...
                    if ('M' === t) {
                      ...
                      (n = e.values[0]), (a = e.values[1]), s.push({ type: 'L', values: [n, a] }), (u = n), (h = a);
                    else if ('l' === t)
                      (n = u + e.values[0]),
                        (a = h + e.values[1]),
                      ...
                      'c' === t
                        ...
                        ? ((n = u + e.values[5]),
                          ...
                          (h = a))
                        : 'H' === t
                        ? ((n = e.values[0]), s.push({ type: 'H', values: [n] }), (u = n))
                        : 'h' === t
                        ? ((n = u + e.values[0]), s.push({ type: 'H', values: [n] }), (u = n))
                        : 'V' === t
                        ? ((a = e.values[0]), s.push({ type: 'V', values: [a] }), (h = a))
                        : 'v' === t
                        ? ((a = h + e.values[0]), s.push({ type: 'V', values: [a] }), (h = a))
                        : 'S' === t
                        ? ((l = e.values[0]),
                          (r = e.values[1]),
                          (n = e.values[2]),
                        ...
                        ? ((n = u + e.values[0]),
                          ...
                          (u = n),
                          (h = a))
                        : ('Z' !== t && 'z' !== t) || (s.push({ type: 'Z', values: [] }), (u = p), (h = c));
                  }),
                  s),
                );
                return (this[f] = y(t)), t;
  ...
  function ce(t, n) {
    ...
    return (
      typeof t != typeof n ||
      (e = k(t) ? 'obj' : Array.isArray(t) ? 'array' : '') != (k(n) ? 'obj' : Array.isArray(n) ? 'array' : '') ||
      ('obj' === e
  ...
  function fe(e) {
    ...
    function l(e) {
      var t = 1,
        n = u.exec(e);
      return (
        n && ((t = parseFloat(n[1])), n[2] ? (t = 0 <= t && t <= 100 ? t / 100 : 1) : (t < 0 || 1 < t) && (t = 1)), t
      );
    }
    return (
  ...
  function be(n, a, i, o, e) {
    ...
    return (
      ...
      [-0.1252, 0.1252, -0.3678, 0.3678, -0.5873, 0.5873, -0.7699, 0.7699, -0.9041, 0.9041, -0.9816, 0.9816].forEach(
        function(e, t) {
  ...
  function ke(e, t, n, a, i) {
    for (var o, l = 0.5, r = 1 - l; (o = be(e, t, n, a, r)), !(Math.abs(o - i) <= 0.01); )
      r += (o < i ? 1 : -1) * (l /= 2);
    return r;
  }
  function we(e, n) {
          ...
          a.push(
            t.length
              ? 2 === t.length
                ...
                : { type: 'C', values: [t[1].x, t[1].y, t[2].x, t[2].y, t[3].x, t[3].y] }
              : { type: 'Z', values: [] },
          );
      }),
      a
  ...
  function Pe(e, t, n, a, i, o, l) {
    ...
    'auto-start-reverse' === n
      ? ('boolean' != typeof h &&
          ...
          (h = t.orientType.baseVal === SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN)),
        h
  ...
  function Be(e) {
    ...
    return (
      'static' !== i.position
        ? ((o.x -= [a.marginLeft, a.borderLeftWidth, a.paddingLeft, i.marginLeft, i.borderLeftWidth].reduce(t, 0)),
          (o.y -= [a.marginTop, a.borderTopWidth, a.paddingTop, i.marginTop, i.borderTopWidth].reduce(t, 0)))
        : 'static' !== a.position &&
  ...
  function Re(e) {
    var t,
      n = e.document;
    n.getElementById(r) ||
      ((t = new e.DOMParser().parseFromString(s, 'image/svg+xml')), n.body.appendChild(t.documentElement), d(e));
  }
  function Fe(u) {
    var _,
      f,
            ...
            g.socketSE[e] ||
              (f[e].width || f[e].height
                ...
                : ((t = b[e ? 0 : 1].x - f[e].left),
                  (n = b[e ? 0 : 1].y - f[e].top),
                  (b[e].socketId = Math.abs(t) >= Math.abs(n) ? (0 <= t ? I : L) : 0 <= n ? C : M)));
          })),
      ...
      switch (((u.pathList.baseVal = v = []), (u.pathList.animVal = null), E.position_path)) {
        ...
        case V:
          (t = ('number' == typeof _[0] && 0 < _[0]) || ('number' == typeof _[1] && 0 < _[1])),
            ...
            (S = { x: b[0].x + Math.cos(r) * d, y: b[0].y + Math.sin(r) * d * -1 }),
            (m = { x: b[1].x + Math.cos(c) * d, y: b[1].y + Math.sin(c) * d * -1 }),
                ...
                : ((a = b[t ? 0 : 1]),
                  (o =
                    0 < (i = E.position_plugOverheadSE[t])
                      ? G + (D < i ? (i - D) * z : 0)
                      : B + (E.position_lineStrokeWidth > R ? (E.position_lineStrokeWidth - R) * F : 0)),
                  e.socketId === M
                    ? ((l = (e.y - a.y) / 2) < o && (l = o), (n = { x: 0, y: -l }))
                    : e.socketId === I
                    ? ((l = (a.x - e.x) / 2) < o && (l = o), (n = { x: l, y: 0 }))
                    : e.socketId === C
                    ? ((l = (a.y - e.y) / 2) < o && (l = o), (n = { x: 0, y: l }))
                    : ((l = (e.x - a.x) / 2) < o && (l = o), (n = { x: -l, y: 0 }))),
                (h[t] = e.x + n.x),
                (p[t] = e.y + n.y);
            }),
        ...
        case T:
          !(function() {
            ...
            function d(e, t, n) {
              ...
              return (
                a.dirId === o ? (a.y -= t) : a.dirId === l ? (a.x += t) : a.dirId === r ? (a.y += t) : (a.x -= t), a
              );
            }
            function f(e, t) {
            ...
            function e() {
              ...
              if (o[0] === o[1]) {
                ...
                n[0] !== n[1]
                  ? ((t = S(n)),
                    (a = m(h[t.notContain], h[t.contain], o[t.notContain])) < H &&
                      (h[t.notContain] = d(h[t.notContain], H - a)),
                    ...
                    (h[t.notContain] = d(
                      ...
                      y(h[t.contain], h[t.notContain])
                        ? 'x' === o[t.notContain]
                          ? r
                          : l
                        : g(h[t.notContain], h[t.contain], 'x' === o[t.notContain] ? 'y' : 'x'),
                    )))
                    ...
                    u.forEach(function(e, t) {
                      ...
                      e.push(h[t]),
                        (h[t] = d(
                          h[t],
                          H,
                          2 * H <= a ? g(h[t], h[n], 'x' === o[t] ? 'y' : 'x') : 'x' === o[t] ? r : l,
                        ));
                    }));
              } else {
                if (n[0] && n[1])
                  return (
                    y(h[1], h[0])
                      ...
                      : y(h[0], h[1])
                      ? u[0].push(h[0])
                      : u[0].push('x' === o[0] ? { x: h[1].x, y: h[0].y } : { x: h[0].x, y: h[1].y }),
                    !1
                  );
                n[0] !== n[1]
                  ? ((t = S(n)),
          ...
          0 < e
            ? 2 === (n = v[(a = d ? 0 : v.length - 1)]).length
              ...
              : ((y[a] = y[a] || be.apply(null, n)),
                y[a] > j &&
                  (y[a] - e < j && (e = y[a] - j),
                  (i = xe(n[0], n[1], n[2], n[3], ke(n[0], n[1], n[2], n[3], d ? e : y[a] - e))),
  ...
  function De(e, t) {
    ...
    t.line &&
      (ee.line =
        ...
        (l = We(n, i, 'line_strokeWidth', a.lineSize, o.cur_line_strokeWidth) || l))),
      (t.plug || ee.line) &&
        (ee.plug =
          ((p = (h = e).options),
          (c = h.curStats),
      ...
      (t.lineOutline || ee.line) &&
        (ee.lineOutline =
          ...
          (S = We(r, y, 'lineOutline_colorTra', fe(y.lineOutline_color)[0] < 1) || S),
          (s = y.line_strokeWidth * u.lineOutlineSize),
          (S = We(r, y, 'lineOutline_strokeWidth', y.line_strokeWidth - 2 * s) || S),
          (S =
            We(
              r,
              y,
              'lineOutline_inStrokeWidth',
              y.lineOutline_colorTra ? y.lineOutline_strokeWidth + 2 * he : y.line_strokeWidth - s,
            ) || S))),
          ...
          [0, 1].forEach(function(e) {
            ...
            (v =
              We(
                ...
                e,
                g.plugOutlineEnabledSE[e] && _.plug_enabled && _.plug_enabledSE[e] && !!a && !!a.outlineBase,
              ) || v),
                ...
                (v =
                  We(
                    ...
                    _.plugOutline_colorTraSE[e]
                      ? t - (he / (_.line_strokeWidth / pe.lineSize) / g.plugSizeSE[e]) * 2
                      : t / 2,
                  ) || v));
          }),
          v)),
      (t.faces || ee.line || ee.plug || ee.lineOutline || ee.plugOutline) &&
        (ee.faces =
          ...
          We(E, k, 'line_strokeWidth', (x = b.line_strokeWidth), w.apl_line_strokeWidth) &&
            ((E.lineShape.style.strokeWidth = x + 'px'),
            (O = !0),
            (re || le) && (Ae(E, E.lineShape), le && (Ae(E, E.lineFace), Ae(E, E.lineMaskCaps)))),
          We(E, k, 'lineOutline_enabled', (x = b.lineOutline_enabled), w.apl_lineOutline_enabled) &&
            ((E.lineOutlineFace.style.display = x ? 'inline' : 'none'), (O = !0)),
          b.lineOutline_enabled &&
            (We(E, k, 'lineOutline_color', (x = b.lineOutline_color), w.apl_lineOutline_color) &&
              ((E.lineOutlineFace.style.stroke = x), (O = !0)),
            We(E, k, 'lineOutline_strokeWidth', (x = b.lineOutline_strokeWidth), w.apl_lineOutline_strokeWidth) &&
              ((E.lineOutlineMaskShape.style.strokeWidth = x + 'px'),
              (O = !0),
              le && (Ae(E, E.lineOutlineMaskCaps), Ae(E, E.lineOutlineFace))),
            We(E, k, 'lineOutline_inStrokeWidth', (x = b.lineOutline_inStrokeWidth), w.apl_lineOutline_inStrokeWidth) &&
          ...
          b.plug_enabled &&
            [0, 1].forEach(function(n) {
              var e = b.plug_plugSE[n],
                t = e !== ne ? ae[ie[e]] : null,
                a = Ne(n, t);
              We(E, k.plug_enabledSE, n, (x = b.plug_enabledSE[n]), w.apl_plug_enabledSE) &&
                ((E.plugsFace.style[a.prop] = x ? 'url(#' + E.plugMarkerIdSE[n] + ')' : 'none'), (O = !0)),
                b.plug_enabledSE[n] &&
                  (We(E, k.plug_plugSE, n, e, w.apl_plug_plugSE) &&
                    ...
                    (O = !0),
                    re && Ae(E, E.plugsFace)),
                  We(E, k.plug_colorSE, n, (x = b.plug_colorSE[n]), w.apl_plug_colorSE) &&
                    ((E.plugFaceSE[n].style.fill = x),
                    (O = !0),
                    (se || ue || le) && !b.line_colorTra && Ae(E, le ? E.lineMaskCaps : E.capsMaskLine)),
                  ['markerWidth', 'markerHeight'].forEach(function(e) {
                    var t = 'plug_' + e + 'SE';
                    We(E, k[t], n, (x = b[t][n]), w['apl_' + t]) &&
                      ((E.plugMarkerSE[n][e].baseVal.value = x), (O = !0));
                  }),
                  We(E, k.plugOutline_enabledSE, n, (x = b.plugOutline_enabledSE[n]), w.apl_plugOutline_enabledSE) &&
                    (x
                      ? ((E.plugFaceSE[n].style.mask = 'url(#' + E.plugMaskIdSE[n] + ')'),
                  ...
                  b.plugOutline_enabledSE[n] &&
                    (We(E, k.plugOutline_plugSE, n, e, w.apl_plugOutline_plugSE) &&
                      ((E.plugOutlineFaceSE[n].href.baseVal = E.plugMaskShapeSE[
                        n
                      ].href.baseVal = E.plugOutlineMaskShapeSE[n].href.baseVal = '#' + t.elmId),
                      ...
                      (O = !0)),
                    We(E, k.plugOutline_colorSE, n, (x = b.plugOutline_colorSE[n]), w.apl_plugOutline_colorSE) &&
                      ((E.plugOutlineFaceSE[n].style.fill = x),
                      (O = !0),
                      le && (Ae(E, E.lineMaskCaps), Ae(E, E.lineOutlineMaskCaps))),
                    We(
                      E,
                    ...
                    ) && ((E.plugOutlineMaskShapeSE[n].style.strokeWidth = x + 'px'), (O = !0)),
                    We(
                      E,
                    ...
                    ) && ((E.plugMaskShapeSE[n].style.strokeWidth = x + 'px'), (O = !0))));
            }),
          O)),
        ...
        (ee.path =
          ...
          A &&
            ...
            Me(I, L.path_pathData) &&
              ...
              (L.path_pathData = I),
              (P = !0),
              le ? (Ae(M, M.plugsFace), Ae(M, M.lineMaskCaps)) : re && Ae(M, M.linePath),
              M.events.apl_path &&
      ...
      (ee.viewBox =
        ...
        (j = N.svg.style),
        (H = !1),
        (T = Math.max(B.line_strokeWidth / 2, B.viewBox_plugBCircleSE[0] || 0, B.viewBox_plugBCircleSE[1] || 0)),
        ...
        ['x', 'y', 'width', 'height'].forEach(function(e) {
          var t;
          (t = G[e]) !== D[e] &&
            ((z[e] = D[e] = t), (j[oe[e]] = t + ('x' === e || 'y' === e ? N.bodyOffset[e] : 0) + 'px'), (H = !0));
        }),
        H)),
      (ee.mask =
        ((Y = (U = e).curStats),
        ...
        We(U, X, 'lineMask_enabled', (Z = Y.lineMask_enabled)) &&
          ((U.lineFace.style.mask = Z ? 'url(#' + U.lineMaskId + ')' : 'none'), (q = !0), ue && Ae(U, U.lineMask)),
        Y.lineMask_enabled &&
          (We(U, X, 'lineMask_outlineMode', (Z = Y.lineMask_outlineMode)) &&
            (Z
              ? ((U.lineMaskBG.style.display = 'none'), (U.lineMaskShape.style.display = 'inline'))
              : ((U.lineMaskBG.style.display = 'inline'), (U.lineMaskShape.style.display = 'none')),
            (q = !0)),
          ['x', 'y'].forEach(function(e) {
            var t = 'lineMask_' + e;
          ...
          We(U, X, 'caps_enabled', (Z = Y.caps_enabled)) &&
            ((U.lineMaskCaps.style.display = U.lineOutlineMaskCaps.style.display = Z ? 'inline' : 'none'),
            (q = !0),
            ue && Ae(U, U.capsMaskLine)),
          Y.caps_enabled &&
            ([0, 1].forEach(function(e) {
              var t;
              We(U, X.capsMaskAnchor_enabledSE, e, (Z = Y.capsMaskAnchor_enabledSE[e])) &&
                ((U.capsMaskAnchorSE[e].style.display = Z ? 'inline' : 'none'), (q = !0), ue && Ae(U, U.lineMask)),
                Y.capsMaskAnchor_enabledSE[e] &&
                  (Me((t = Y.capsMaskAnchor_pathDataSE[e]), X.capsMaskAnchor_pathDataSE[e]) &&
                    (U.capsMaskAnchorSE[e].setPathData(t), (X.capsMaskAnchor_pathDataSE[e] = t), (q = !0)),
                  We(U, X.capsMaskAnchor_strokeWidthSE, e, (Z = Y.capsMaskAnchor_strokeWidthSE[e])) &&
                    ((U.capsMaskAnchorSE[e].style.strokeWidth = Z + 'px'), (q = !0)));
            }),
            We(U, X, 'capsMaskMarker_enabled', (Z = Y.capsMaskMarker_enabled)) &&
              ((U.capsMaskLine.style.display = Z ? 'inline' : 'none'), (q = !0)),
            Y.capsMaskMarker_enabled &&
              [0, 1].forEach(function(n) {
                var e = Y.capsMaskMarker_plugSE[n],
                  t = e !== ne ? ae[ie[e]] : null,
                  a = Ne(n, t);
                We(U, X.capsMaskMarker_enabledSE, n, (Z = Y.capsMaskMarker_enabledSE[n])) &&
                  ((U.capsMaskLine.style[a.prop] = Z ? 'url(#' + U.lineMaskMarkerIdSE[n] + ')' : 'none'), (q = !0)),
      ...
      t.effect &&
        ...
        Object.keys(te).forEach(function(e) {
          ...
          We(Q, $, n, (K = J[n]))
            ...
            : K && ce(i, $[a]) && (t.remove(Q), ($[n] = !0), ($[a] = de(i)), t.init(Q));
        })),
  ...
  function je(e, t, n, a) {
    ...
    (o.show_on = t),
      n && g[n] && ((o.show_effect = n), (o.show_animOptions = ze(k(a) ? a : {}, g[n].defaultAnimOptions))),
      ...
      r.show_effect || r.show_animOptions
        ? o.show_inAnim
          ? ((i = r.show_effect ? g[l.show_effect].stop(e, !0, !0) : g[l.show_effect].stop(e)),
            s(),
            g[l.show_effect].init(e, i))
          : r.show_on &&
            (l.show_effect && r.show_effect && g[l.show_effect].stop(e, !0, !0), s(), g[l.show_effect].init(e))
        : r.show_on && (s(), g[l.show_effect].start(e));
  }
  function He(e, t, n) {
    var a = { props: e, optionName: n };
    return (
      !(!(e.attachments.indexOf(t) < 0) || (t.conf.bind && !t.conf.bind(t, a))) &&
  ...
  function Ze(s, u) {
    ...
    if (
      ...
      ['start', 'end'].forEach(function(e, t) {
        ...
        if (n && (ye(n) || (a = _(n, 'anchor'))) && n !== h.anchorSE[t]) {
          if ((!1 !== s.optionIsAttach.anchorSE[t] && Ue(s, $[h.anchorSE[t]._id]), a && !He(s, $[n._id], e)))
    ...
    i &&
      (e = (function(e, t) {
        ...
        !1 !== s.optionIsAttach.anchorSE[0] ? $[h.anchorSE[0]._id].element : h.anchorSE[0],
        !1 !== s.optionIsAttach.anchorSE[1] ? $[h.anchorSE[1]._id].element : h.anchorSE[1],
      )) !== s.baseWindow &&
      (!(function(a, e) {
        var t,
          n,
          ...
          (Array.isArray(e)
            ? w(e[0]) &&
              ...
              Array.isArray(h.socketGravitySE[t]) &&
                ...
                (i = !1))
            : ((e + '').toLowerCase() === x ? (i = null) : w(e) && 0 <= e && (i = e),
      ...
      ['startPlug', 'endPlug'].forEach(function(e, t) {
        (p.plug = c(h, u, e, E, 'plugSE', t, pe.plugSE[t]) || p.plug),
          ...
          (p.plug =
            d(h, u, e + 'Size', null, 'plugSizeSE', t, pe.plugSizeSE[t], function(e) {
              return 0 < e;
            }) || p.plug);
      }),
      (p.lineOutline = d(h, u, 'outline', null, 'lineOutlineEnabled', null, pe.lineOutlineEnabled) || p.lineOutline),
      (p.lineOutline =
        d(h, u, 'outlineColor', null, 'lineOutlineColor', null, pe.lineOutlineColor, null, !0) || p.lineOutline),
      (p.lineOutline =
        d(h, u, 'outlineSize', null, 'lineOutlineSize', null, pe.lineOutlineSize, function(e) {
          return 0 < e && e <= 0.48;
        }) || p.lineOutline),
      ['startPlugOutline', 'endPlugOutline'].forEach(function(e, t) {
        (p.plugOutline = d(h, u, e, null, 'plugOutlineEnabledSE', t, pe.plugOutlineEnabledSE[t]) || p.plugOutline),
          ...
          (p.plugOutline =
            d(h, u, e + 'Size', null, 'plugOutlineSizeSE', t, pe.plugOutlineSizeSE[t], function(e) {
              return 1 <= e;
            }) || p.plugOutline);
      }),
      ['startLabel', 'endLabel', 'middleLabel'].forEach(function(e, t) {
        ...
        if (((n = 'string' == typeof o) && (o = o.trim()), (n || (o && (r = _(o, 'label')))) && o !== l)) {
          if ((h.labelSEM[t] && (Ue(s, $[h.labelSEM[t]._id]), (h.labelSEM[t] = '')), o)) {
            if (
              (r
                ? (a = $[(i = o)._id]).boundTargets.slice().forEach(function(e) {
          ...
          return (
            e.hasOwnProperty('animation')
              ? k(e.animation)
                ...
                : ((t = !!e.animation), (s.curStats[n] = t ? ze({}, o.defaultAnimOptions) : null))
              : ((t = !!o.defaultEnabled), (s.curStats[n] = t ? ze({}, o.defaultAnimOptions) : null)),
            t
          );
        }
        u.hasOwnProperty(a) &&
          ((e = u[a]),
          k(e)
            ? ((s.curStats[n] = !0), (t = s.curStats[i] = l(e)), o.anim && (s.curStats[i].animation = r(e)))
            : (t = s.curStats[n] = !!e) && ((s.curStats[i] = l({})), o.anim && (s.curStats[i].animation = r({}))),
            ...
            n.dash_animOptions
              ? ((o = We(t, a, 'dash_maxOffset', n.dash_maxOffset)),
                a.dash_animOptions &&
                  ...
                  (n.dash_animId && ((e = c.stop(n.dash_animId)), c.remove(n.dash_animId)),
              ...
              : a.dash_animOptions &&
                (n.dash_animId && (c.remove(n.dash_animId), (n.dash_animId = null)),
      ...
      gradient: {
        ...
        remove: function(e) {
          e.efc_gradient_gradient &&
            (e.defs.removeChild(e.efc_gradient_gradient), (e.efc_gradient_gradient = e.efc_gradient_stopSE = null)),
              ...
              We(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                ...
                ['x', 'y'].forEach(function(e) {
                  (n = i.gradient_pointSE[t][e]) !== o.gradient_pointSE[t][e] &&
                    (a.efc_gradient_gradient[e + (t + 1)].baseVal.value = o.gradient_pointSE[t][e] = n);
                });
            });
        },
      },
        ...
        init: function(t) {
          var e,
            ...
            u =
              ...
              (n = s),
              (o = {}),
              'boolean' != typeof p && (p = !!window.SVGFEDropShadowElement && !ue),
              (o.elmsAppend = [(o.elmFilter = a = e.createElementNS(b, 'filter'))]),
              ...
              (a.id = n),
              p
                ? ((o.elmOffset = o.elmBlur = i = a.appendChild(e.createElementNS(b, 'feDropShadow'))),
                  (o.styleFlood = i.style))
                : ((o.elmBlur = a.appendChild(e.createElementNS(b, 'feGaussianBlur'))),
                  (o.elmOffset = i = a.appendChild(e.createElementNS(b, 'feOffset'))),
                  (i.result.baseVal = 'offsetblur'),
                  (i = a.appendChild(e.createElementNS(b, 'feFlood'))),
                  (o.styleFlood = i.style),
                  ((i = a.appendChild(e.createElementNS(b, 'feComposite'))).in2.baseVal = 'offsetblur'),
                  (i.operator.baseVal = SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN),
                  (i = a.appendChild(e.createElementNS(b, 'feMerge'))).appendChild(e.createElementNS(b, 'feMergeNode')),
      ...
      draw: {
                ...
                if (0 === e) n = [[l[0][0], l[0][0]]];
                  ...
                  t &&
                    (2 === (a = l[o]).length
                      ...
                      : ((i = xe(a[0], a[1], a[2], a[3], ke(a[0], a[1], a[2], a[3], t))),
        ...
        stop: function(e, t, n) {
          ...
          return (
            ...
            (i.show_inAnim = !1),
            t &&
              ((e.pathList.animVal = n ? null : [[e.pathList.baseVal[0][0], e.pathList.baseVal[0][0]]]),
              De(e, { path: !0 }),
              Ge(e, n)),
            a
          );
      ...
      function e(e, t) {
        ...
        e.argOptions.every(function(e) {
          return (
            !(
              !t.length ||
              ('string' == typeof e.type ? typeof t[0] !== e.type : 'function' != typeof e.type || !e.type(t[0]))
    ...
    (y = {
      pointAnchor: {
        ...
        parsePercent: function(e, t) {
          ...
          return (
            w(e)
              ? (a = e)
              : 'string' == typeof e && (n = u.exec(e)) && n[2] && (i = 0 !== (a = parseFloat(n[1]) / 100)),
      ...
      areaAnchor: {
            ...
            'circle' === e.shape
              ...
              : 'polygon' === e.shape &&
                ...
                e.points.every(function(e) {
                  var t = {};
                  return (
                    !(!(t.x = y.pointAnchor.parsePercent(e[0], !0)) || !(t.y = y.pointAnchor.parsePercent(e[1], !0))) &&
                    (o.push(t), (t.x[1] || t.y[1]) && (i.hasRatio = !0), !0)
                  );
                })
              ? ((i.shape = e.shape), (i.points = o))
              : ((i.shape = 'rect'), (i.radius = w(e.radius) && 0 <= e.radius ? e.radius : 0)),
        ...
        update: function(t) {
          var a,
            ...
            W = {};
          if (
            ((W.strokeWidth = We(t, P, 'strokeWidth', null != t.size ? t.size : T ? T.line_strokeWidth : pe.lineSize)),
            (a = Se(t.element)),
                ...
                ((v = {
                  ...
                  (E = t.radius ? (t.radius <= x ? t.radius : x) : 0)
                    ? ((O = E - (w = (E - k) / Math.SQRT2)),
                      ...
                      (P.pathListRel = [[M[0], { x: M[0].x, y: M[0].y - I }, { x: M[1].x - I, y: M[1].y }, M[1]]]),
                      M[1].x !== M[2].x && P.pathListRel.push([M[1], M[2]]),
                      P.pathListRel.push([M[2], { x: M[2].x + I, y: M[2].y }, { x: M[3].x, y: M[3].y - I }, M[3]]),
                      M[3].y !== M[4].y && P.pathListRel.push([M[3], M[4]]),
                      P.pathListRel.push([M[4], { x: M[4].x, y: M[4].y + I }, { x: M[5].x + I, y: M[5].y }, M[5]]),
                      M[5].x !== M[6].x && P.pathListRel.push([M[5], M[6]]),
                      P.pathListRel.push([M[6], { x: M[6].x - I, y: M[6].y }, { x: M[7].x, y: M[7].y + I }, M[7]]),
                    ...
                    : ((O = P.strokeWidth / 2),
                      ...
                      (M = [
                        ...
                        { x: v.right + P.strokeWidth, y: v.bottom + P.strokeWidth },
                      ])),
                  (P.bBoxRel = {
                    left: M[0].x,
                    top: M[0].y,
          ...
          return (
            ...
            t.dash &&
              ((!W.pathData && (!W.strokeWidth || (t.dashLen && t.dashGap))) ||
                ((P.dashLen = t.dashLen || 2 * P.strokeWidth), (P.dashGap = t.dashGap || P.strokeWidth)),
            ...
            ['x', 'y', 'width', 'height'].forEach(function(e) {
              (n = C[e]) !== L[e] &&
                ((A[e] = L[e] = n), (V[oe[e]] = n + ('x' === e || 'y' === e ? t.bodyOffset[e] : 0) + 'px'));
            }),
      ...
      mouseHoverAnchor: {
        ...
        init: function(a, i) {
          ...
          if (
            ...
            (u = a.element),
            !((p = u.ownerDocument) && (h = p.defaultView) && h.HTMLElement && u instanceof h.HTMLElement))
          )
          ...
          return (
            ...
            'inline' === (o = a.element.ownerDocument.defaultView.getComputedStyle(a.element, '')).display
                ...
                ? ((c = d.minHeight),
                  'content-box' === o.boxSizing
                    ...
                    : 'padding-box' === o.boxSizing &&
                      (c -= parseFloat(o.borderTopWidth) + parseFloat(o.borderBottomWidth)),
                  (a.style.height = c + 'px'))
        ...
        bind: function(e, t) {
          ...
          return (
            ...
            e.enabled ||
              ((e.styleSave = y.mouseHoverAnchor.getStyles(e.elmStyle, Object.keys(e.style))),
                    ...
                    (o = function(e) {
                      (e.relatedTarget &&
                        (e.relatedTarget === this ||
                          this.compareDocumentPosition(e.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY)) ||
        ...
        unbind: function(e, t) {
          e.enabled &&
            ...
            (e.removeEventListener(), y.mouseHoverAnchor.setStyles(e.elmStyle, e.styleSave), (e.enabled = !1)),
      ...
      captionLabel: {
            ...
            !!u.text &&
                  ...
                  (u.offset
                    ...
                    : ((t = u.height / 2),
                      ...
                      s.socketId === L || s.socketId === I
                        ? ((o.x = s.socketId === L ? s.x - t - u.width : s.x + t),
                          (o.y = a.y < s.y ? s.y + n + t : s.y - n - t - u.height))
                        : ((o.x = a.x < s.x ? s.x + n + t : s.x - n - t - u.width),
                          (o.y = s.socketId === M ? s.y - t - u.height : s.y + t))),
                  We(u, l, 'x', (i = o.x)) && (u.elmPosition.x.baseVal.getItem(0).value = i),
              ...
              (u.updatePath = function(e) {
                ...
                o &&
                  ...
                  (a.x = t.x - u.width / 2),
                  (a.y = t.y - u.height / 2),
                  We(u, i, 'x', (n = a.x)) && (u.elmPosition.x.baseVal.getItem(0).value = n),
          ...
          return (
            ...
            i && !f
              ? ((r = t.createElementNS(b, 'defs')),
                (o.id = a),
                r.appendChild(o),
                ((u = (l = t.createElementNS(b, 'g')).appendChild(t.createElementNS(b, 'use'))).href.baseVal = '#' + a),
                ((s = l.appendChild(t.createElementNS(b, 'use'))).href.baseVal = '#' + a),
        ...
        getMidPoint: function(e, t) {
          var n,
            ...
            s = -1;
          if ((n = r / 2 + (t || 0)) <= 0)
            return 2 === (a = e[0]).length ? ve(a[0], a[1], 0) : xe(a[0], a[1], a[2], a[3], 0);
      ...
      pathLabel: {
                  ...
                  (2 !== s.semIndex || s.lineOffset) &&
                    ((t = o.pathData.reduce(function(e, t) {
                      ...
                      switch (t.type) {
                        ...
                        case 'C':
                          (n = { x: a[4], y: a[5] }),
                            i && (e += be(i, { x: a[0], y: a[1] }, { x: a[2], y: a[3] }, n)),
                            (i = n);
                      }
                      return e;
                    }, 0)),
                    ...
                    2 !== s.semIndex &&
                      ((n =
                        Math.max(r.attach_plugBackLenSE[s.semIndex] || 0, r.line_strokeWidth / 2) +
                        s.strokeWidth / 2 +
                        s.height / 4),
                      (a = (a += 0 === s.semIndex ? n : -n) < 0 ? 0 : t < a ? t : a)),
                    s.lineOffset && (a = (a += s.lineOffset) < 0 ? 0 : t < a ? t : a),
                    (o.startOffset = a),
                    We(s, l, 'startOffset', a) && (s.elmOffset.startOffset.baseVal.value = a));
              }),
          ...
          return (
              ...
              2 === e.length
                    ...
                    ? ((a = b.points),
                      0 <=
                        (i =
                          ...
                          Math.atan2(e[0].y - e[1].y, e[1].x - e[0].x)) && i <= Math.PI
                        ...
                        : ((l = Ee(a[0], a[1], x)),
                          ...
                          (f = p.x - h.x),
                          (y = p.y - h.y),
                          (S = (-d * (s.x - h.x) + c * (s.y - h.y)) / (-f * d + c * y)),
                          (m = (f * (s.y - h.y) - y * (s.x - h.x)) / (-f * d + c * y)),
                          (r = 0 <= S && S <= 1 && 0 <= m && m <= 1 ? { x: s.x + m * c, y: s.y + m * d } : null)
                            ? (n = { type: 'line', points: [(a[1] = r), t[1]] })
                            : ((a[1] = w(o, l) ? o : l), (n = { type: 'line', points: [o, t[1]] })),
                          (b.len = _e(a[0], a[1]))))
                ...
                : (k.push({
                    ...
                    points: (function(e, t, n, a, i, o) {
                      for (
                        var l, r, s = be(e, t, n, a) / o, u = 1 / (o < i ? s * (i / o) : s), h = [], p = 0;
                        (r = (90 - (l = xe(e, t, n, a, p)).angle) * (Math.PI / 180)),
            ...
            k.forEach(function(e) {
              ...
              'line' === e.type
                ? (e.inside &&
                    (b.len > x
                      ? (((t = b.points)[1] = Ee(t[0], t[1], -x)), (b.len = _e(t[0], t[1])))
                      : ((b.points = null), (b.len = 0)),
                    e.len > x + n
                      ? (((t = e.points)[0] = Ee(t[1], t[0], -(x + n))), (e.len = _e(t[0], t[1])))
        ...
        newText: function(e, t, n, a) {
          ...
          return (
            ((r = (l = t.createElementNS(b, 'defs')).appendChild(t.createElementNS(b, 'path'))).id = i = n + '-path'),
            ((u = (s = t.createElementNS(b, 'text')).appendChild(t.createElementNS(b, 'textPath'))).href.baseVal =
              '#' + i),
            ...
            a && !f
              ? ((s.id = o = n + '-text'),
                l.appendChild(s),
                ((c = (h = t.createElementNS(b, 'g')).appendChild(t.createElementNS(b, 'use'))).href.baseVal = '#' + o),
                ((p = h.appendChild(t.createElementNS(b, 'use'))).href.baseVal = '#' + o),
        ...
        initSvg: function(t, n) {
          ...
          ['elmPosition', 'elmPath', 'elmOffset', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function(e) {
            ...
            2 !== t.semIndex ||
              t.lineOffset ||
              i.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE, 50),
            (t.height = e.height),
            t.outlineColor &&
              ((a = 10 < (a = e.height / 9) ? 10 : a < 2 ? 2 : a),
              (i.styleStroke.strokeWidth = a + 'px'),
